...
const mySuggestions = document.querySelector('#suggestions') as HTMLInputElement

const input1 = document.querySelector('#sun') as HTMLInputElement
const input2 = document.querySelector('#moon') as HTMLInputElement
const input3 = document.querySelector('#rising') as HTMLInputElement
